...
var VerificationManager = /** @class */ (function () {
    ...
    VerificationManager.prototype.start = function () {
    ...
    VerificationManager.prototype.sendValidationMessage = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var embed;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    VerificationManager.prototype.refreshOnReset = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    VerificationManager.prototype.refresh = function () {
    ...
    VerificationManager.prototype.refreshFileData = function (msg) {
    ...
    VerificationManager.prototype.resetVerificationData = function () {
        var file = FileManager_1.BotFiles.verification();
    ...
    VerificationManager.prototype.startListeners = function () {
        return __awaiter(this, void 0, void 0, function () {
                                ...
                                switch (_a.label) {
                                    case 0:
                                        if (reaction.emoji.name !== '✅')
                                            return [2 /*return*/];
                                        member = msg.guild.member(user);
                                        return [4 /*yield*/, member.send("Du bist gerade dabei deine Regelbest\u00E4tigung zur\u00FCckzuziehen, das bedeutet du verlierst alle deine Rollen. " +
                                                'Bitte bestätige erneut, dass du die Regeln nicht weiter akzeptierst indem du auf ❌ klickst. Wenn du dich nur verklickt hast, ' +
                                                'dann brauchst du nichts machen :D').then(function (msg) {
                                                message = msg;
                                                _this.processMessageForUser(msg, message, reaction, member);
                                            }).catch(function () { return __awaiter(_this, void 0, void 0, function () {
                                                var _this = this;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4 /*yield*/, reaction.message.channel.send("Du, <@" + user.id + ">, bist gerade dabei deine Regelbest\u00E4tigung zur\u00FCckzuziehen," +
                                                                'das bedeutet du verlierst alle deine Rollen. Bitte bestätige erneut, dass du die Regeln nicht weiter akzeptierst ' +
                                                                'indem du auf ❌ klickst. Wenn du dich nur verklickt hast, dann brauchst du nichts machen :D').then(function (msg) {
                                                                message = msg;
                                                                _this.processMessageForUser(msg, message, reaction, member);
                                                            })];
                                                        case 1:
    ...
    VerificationManager.prototype.processMessageForUser = function (msg, message, reaction, member) {
        return __awaiter(this, void 0, void 0, function () {
            var user, collector;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        collector = message.createReactionCollector(function () { return true; }, {});
                        collector.on('collect', function (r, u) { return __awaiter(_this, void 0, void 0, function () {
                            var i;
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (r.emoji.name !== '❌')
                                            return [2 /*return*/];
                                        if (!(u.id === user.id)) return [3 /*break*/, 2];
                        ...
                        collector.on('end', function (_collected, reason) {
